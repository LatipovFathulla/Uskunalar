...
class GalleryModel(models.Model):
    ...
    short_descriptions = models.TextField(verbose_name=_('short_description'), null=True,)
    long_descriptions = models.TextField(verbose_name=_('long_description'), null=True,)
